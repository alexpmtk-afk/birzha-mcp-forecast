...
def test_flow_refines_but_cannot_dominate_long_horizon_score() -> None:
    ...
    assert forecast.engine_version == "BIRZHA_FORECAST_BASELINE_V0_4_SCENARIOS"
    ...
    assert forecast.primary_scenario is not None
    assert forecast.alternative_scenario is not None
    assert forecast.key_levels
