...
def test_prepare_history_primes_only_d1_and_optional_flow():
    ...
    assert [item[1] for item in history.calls] == ["D1"]
    assert history.calls[0][2] == "2025-09-04"
    assert history.calls[0][3] == "2026-09-01"
