...
Recurring application processes must not issue schema DDL on every startup.
Provisioning classes remain available in their original modules; these runtime
variants reuse the same data path while skipping CREATE TABLE operations.
